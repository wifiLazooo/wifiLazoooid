...
class HoriziontalTabStrip extends LinearLayout {
    ...
    private HorizontalTabLayout.TabColorizer mCustomTabColorizer;
    private final SimpleTabColorizer mDefaultTabColorizer;

    HoriziontalTabStrip(Context context) {
        this(context, null);
    }

    HoriziontalTabStrip(Context context, AttributeSet attrs) {
    ...
    void setCustomTabColorizer(HorizontalTabLayout.TabColorizer customTabColorizer) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final HorizontalTabLayout.TabColorizer tabColorizer = mCustomTabColorizer != null
                ? mCustomTabColorizer
    ...
    private static class SimpleTabColorizer implements HorizontalTabLayout.TabColorizer {
